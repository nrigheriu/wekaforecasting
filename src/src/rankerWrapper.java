...
public class rankerWrapper {
    ...
    public static Float[] getPercentagesForIntervals(myWekaForecaster forecaster, Instances data, PrintWriter resultLog){
    ...
    public static ArrayList<Integer> getFeatureList(myWekaForecaster forecaster){
