...
public class Evaluation implements Serializable, Summarizable, RevisionHandler {
  ...
  protected src.evaluation.Evaluation m_delegate;
  ...
  public Evaluation(Instances data) throws Exception {
    m_delegate = new src.evaluation.Evaluation(data);
  }

  public Evaluation(Instances data, CostMatrix costMatrix) throws Exception {
    m_delegate = new src.evaluation.Evaluation(data, costMatrix);
  }
   ...
   */
  public List<src.evaluation.AbstractEvaluationMetric> getPluginMetrics() {
   ...
   *         metrics
   */
  public src.evaluation.AbstractEvaluationMetric getPluginMetric(String name) {
  ...
  public boolean equals(Object obj) {
    if (obj instanceof weka.classifiers.Evaluation) {
      obj = ((src.Evaluation) obj).m_delegate;
    }
