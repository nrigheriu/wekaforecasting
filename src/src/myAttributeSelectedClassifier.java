 ...
 */
public class myAttributeSelectedClassifier
    ...
    protected myAttributeSelection m_AttributeSelection = null;
     ...
     * Default constructor.
     */
    public myAttributeSelectedClassifier() {
    ...
    public void buildClassifier(Instances data) throws Exception {
        ...
        m_AttributeSelection = new myAttributeSelection();
    ...
    public static void main(String [] argv) {
        runClassifier(new myAttributeSelectedClassifier(), argv);
    }
}
