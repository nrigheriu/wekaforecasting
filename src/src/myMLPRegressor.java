...
import weka.classifiers.functions.MLPModel;
 ...
 */
public class myMLPRegressor extends myMLPModel implements WeightedInstancesHandler {
  ...
  public static void main(String[] argv) {
    ...
    runClassifier(new myMLPRegressor(), argv);
  }
}
