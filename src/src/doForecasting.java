...
public class doForecasting {
    ...
    public static void doForecasting(Instances data, Classifier classifier){
        try {
            PrintWriter resultLog = new PrintWriter(new FileWriter("/home/cycle/workspace/wekaforecasting-new-features/newer-results.txt", true));

            long startTime = System.currentTimeMillis();
            WekaForecaster forecaster = new WekaForecaster();
            myHashMap hashMap = new myHashMap();
            for (int i = 1; i < 1340; i+=48) {
            ...
            String chosenLags = myHashMap.printHashMapFeatures(hashMap, 100);
