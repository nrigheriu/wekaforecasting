...
public class doForecasting {
    ...
    public static void doForecasting(Instances data, Classifier classifier){
        try {
            ...
            myWekaForecaster forecaster = new myWekaForecaster();
            ...
            forecaster.setBaseForecaster(new myMLPRegressor());                 //running classifier on attributes ranked by rankedWrapper
    ...
    public static void crossValidateTS(Instances data, myWekaForecaster forecaster){
        try {
