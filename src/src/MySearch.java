 ...
 */
public class MySearch extends ASSearch implements OptionHandler,
        StartSetHandler {
    ...
    public int[] search(ASEvaluation ASEval, Instances data) throws Exception {
        ...
        while (stale < m_maxStale) {
            ...
            if (bfList.size() == 0) {
                stale = m_maxStale;
                System.out.println("Finished search w/o stalling");
                break;
            }
             ...
             */
                        ...
                        if (sd == SELECTION_FORWARD) {
                            z = ((merit - best_merit) > 0.00001);      //0.00001  ((merit - best_merit) > 0.00001)
                        } else {
                            if (merit == best_merit) {
                                z = (size < best_size);
                            } else {
